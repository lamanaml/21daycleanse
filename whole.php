...
<!-- content Body -->
   <div class="container intro">  
        ...
        <p class="card-text">Need a little inspiration?  Check out some of our <a href="https://culinaryhealing21days.com/recipes/?cat=4">Whole Food Recipes</a>!</p>
    </div>
    ...
    <!-- card 1 -->
      <div class="card">
        ...
        <div class="card-body">
         ...
         <p class="card-text">Once we find them,  <a href="http://culinaryhealing21days.com/notes/">   Ready, set, gooo! </p>
        </div>
      </div>
